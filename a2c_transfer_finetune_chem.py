...
def arg_parse():
    ...
    parser.add_argument('--input_model_file', type=str, default='./models_ga2c/chem/1024pretrain_ga2c_seed_2024_reg_0.0_epoch_10.pth',
...
def run(args):
    ...
    logging.info('FinalTestScore: {}'.format(best_test_acc))
...
if __name__ == "__main__":
    args = arg_parse()
    data_list = ['bbbp', 'bace', 'tox21', 'toxcast', 'sider', 'clintox', 'muv', 'hiv']
